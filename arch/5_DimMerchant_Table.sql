CREATE TABLE dw.DimMerchant (
    ...
    EffectiveStartDate DATE NOT NULL
        CONSTRAINT DF_DimMerchant_EffectiveStartDate
        DEFAULT ('19000101'),

    EffectiveEndDate DATE NOT NULL
        CONSTRAINT DF_DimMerchant_EffectiveEndDate
        DEFAULT ('99991231'),

    IsCurrent BIT NOT NULL
        CONSTRAINT DF_DimMerchant_IsCurrent
        DEFAULT (1),
    ...
    CONSTRAINT CK_DimMerchant_EffectiveDates
