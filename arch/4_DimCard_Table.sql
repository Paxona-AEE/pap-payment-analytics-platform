CREATE TABLE dw.DimCard (                     --Star Schema? Fits!
    ...
    EffectiveStartDate DATE NOT NULL
        CONSTRAINT DF_DimCard_EffectiveStartDate
        DEFAULT ('19000101'),

    EffectiveEndDate DATE NOT NULL
        CONSTRAINT DF_DimCard_EffectiveEndDate
        DEFAULT ('99991231'),

    IsCurrent BIT NOT NULL
        CONSTRAINT DF_DimCard_IsCurrent
        DEFAULT (1),
    ...
    CONSTRAINT CK_DimCard_EffectiveDates
